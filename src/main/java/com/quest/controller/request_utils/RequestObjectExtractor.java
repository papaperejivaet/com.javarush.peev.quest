...
public class RequestObjectExtractor
{
    ...
    protected Question getCurrentQuestion(HttpServletRequest req, HttpServletResponse resp, Quest quest)
    {
    ...
    protected Answer getAnswer(HttpServletRequest req, HttpServletResponse resp, Question question)
    {
